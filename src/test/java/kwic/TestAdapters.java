...
public class TestAdapters {
    ...
    void Test_Assignment2_Core_001() {
        ...
        String txtIgnore = "";
        ArrayList<ArrayList<String>> sourceLines = TO_ITERABLE_TITLES(txtSource);
        ...
        String output = TO_STRING(sortedShiftedLines);
...
//
        ...
        ArrayList<String> ignores = TO_ITERABLE_KEYWORDS(READ(ignorePath));
