...
public class TestIgnore {
    ...
    private static final Selector.SelectionFilter FILTER_1 = Selector.newIgnoreFilter(Selector.newIgnoreLinePredicate(Adapter.toHashSet(TestIgnore.IGNORES_1)));
    private static final Selector.SelectionFilter FILTER_2 = Selector.newIgnoreFilter(Selector.newIgnoreLinePredicate(Adapter.toHashSet(TestIgnore.IGNORES_2)));
