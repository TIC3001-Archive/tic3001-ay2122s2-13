...
public class TestRequire {
    ...
    private static final Selector.SelectionFilter FILTER_1 = Selector.newRequireFilter(Selector.newRequiredLineByFirstWordPredicate(ArrayListToHashSet(TestRequire.REQUIRES_1)));
    private static final Selector.SelectionFilter FILTER_2 = Selector.newRequireFilter(Selector.newRequiredLineByFirstWordPredicate(ArrayListToHashSet(TestRequire.REQUIRES_2)));
