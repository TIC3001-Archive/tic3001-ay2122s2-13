...
public class TestRequire {
    ...
    private static final Selector.SelectionFilter FILTER_1 = Selector.newRequireFilter(Selector.newRequiredLineByFirstWordPredicateAgainstSet(arrayListToHashSet(TestRequire.REQUIRES_1)));
    private static final Selector.SelectionFilter FILTER_2 = Selector.newRequireFilter(Selector.newRequiredLineByFirstWordPredicateAgainstSet(arrayListToHashSet(TestRequire.REQUIRES_2)));
